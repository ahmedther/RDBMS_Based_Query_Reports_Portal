...
class Oracle:
    ...
    def __init__(self):
        self.cursor = connections['oracle'].cursor()
...
a.ADMISSION_DATE_TIME as Admitted_On  
 ...
 AND ST_SAL_DTL.ADDED_DATE between to_date(:from_date   '00:00:00','dd/mm/yyyy hh24:mi:ss') and to_date(:to_date  '23:59:59','dd/mm/yyyy hh24:mi:ss') 
...
''')
    ...
    def get_credit_outstanding_bill_value(self,from_date,to_date):
...
''')
    ...
    def get_gst_data_of_pharmacy_return(self):
        ...
        self.cursor.execute(pharmacy_return_qurey)
        pharmacy_return_data = self.cursor.fetchall()
                 
        return pharmacy_return_data


    def gst_data_of_ip(self):
...
''')
    ...
    def employees_antibodies_reactive_report(self,from_date,to_date,facility_code):
...
''')
        ...
        self.cursor.execute(employees_antibodies_reactive_report_qurey,[from_date,to_date,facility_code])
...
''')
    ...
    def get_stock(self):
        ...
        self.cursor.execute(stock_qurey)
        get_stock_data = self.cursor.fetchall()
    ...
    def get_covid_pcr(self,facility_code,from_date,to_date):
       ...
       SELECT  o.ord_date_time,SPEC_REGD_DATE_TIME,s.long_desc orderstatus,l.modified_date stat_change_date,CATALOG_DESC,A.PATIENT_ID,
        ...
        and t.SPECIMEN_NO(+) = a.SPECIMEN_NO AND o.ORDER_ID = l.ORDER_ID and s.ORDER_STATUS_CODE(+) = o.ORDER_STATUS 
        and o.PATIENT_ID = b.PATIENT_ID and o.episode_id = b.episode_id 
        and e.PATIENT_ID = o.PATIENT_ID and e.EPISODE_ID = o.EPISODE_ID and  o.ORDERING_FACILITY_ID=:facility_code AND o.ORD_DATE_TIME BETWEEN :from_date to :to_date
...
and a.VISIT_ADM_DATE_TIME between :from_date and to_date(:to_date)+1 and a.cancel_reason_code is null order by a.VISIT_ADM_DATE_TIME 
