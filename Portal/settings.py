...
#ALLOWED_HOSTS = ['127.0.0.1', 'localhost','172.20.200.40',"http://localhost:8001","http://172.20.200.40:8001"]
...
#CSRF_TRUSTED_ORIGINS = ['127.0.0.1', 'localhost','http://172.20.200.40:8001',"http://localhost:8001"]